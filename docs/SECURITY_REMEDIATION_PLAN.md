...
- **What.** `pk_live_REDACTED_STRIPE_PUBLISHABLE` appears as a fallback in `client/src/lib/stripe-config.ts:5` and quoted in `CLAUDE.md`, `xcode-cloud-workflow.md`, `docs/XCODE_CLOUD_ENV_SETUP.md`, `CLAUDE-MOBILE.md`.
