  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50 relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-blue-300/20 to-blue-400/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-green-300/20 to-emerald-400/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="px-4 pt-8 pb-4">
          ...
          <p className="text-center text-sm text-gray-600 mt-4 font-light">
            Portal exclusivo para pacientes do Hospital São José
          </p>
        </div>
        ...
        <div 
          ...
          <Tabs defaultValue="register" value={activeTab} onValueChange={(value) => {
            ...
            <TabsList className={`grid w-full grid-cols-2 p-0.5 bg-gray-100/60 backdrop-blur-sm rounded-lg shadow-lg ${activeTab === 'login' ? 'mb-3' : 'mb-4'}`}>
              <TabsTrigger value="login" className="rounded-md py-2 text-sm data-[state=active]:bg-white data-[state=active]:shadow-lg data-[state=active]:text-[#4A7766]" style={{ transition: 'all 200ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1" />
                </svg>
                Login
              </TabsTrigger>
              <TabsTrigger value="register" className="rounded-md py-2 text-sm data-[state=active]:bg-white data-[state=active]:shadow-lg data-[state=active]:text-[#4A7766]" style={{ transition: 'all 200ms cubic-bezier(0.4, 0, 0.2, 1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <TabsContent value="login">
            <div className="relative p-4 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-blue-900/10 border border-white/60 overflow-hidden">
              ...
              <div className="absolute -top-24 -right-24 w-48 h-48 bg-gradient-to-br from-[#4A7766]/20 to-[#D4AF37]/20 rounded-full blur-3xl animate-pulse" />
              <div className="absolute -bottom-24 -left-24 w-48 h-48 bg-gradient-to-tr from-[#4A7766]/20 to-[#3A5F52]/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
              ...
              <Form {...loginForm}>
                ...
                >
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <input 
                              ...
                              className="pl-9 pr-3 py-2.5 rounded-xl h-10 text-xs bg-gray-50/50 border border-gray-200/50 focus:border-[#4A7766] focus:ring-4 focus:ring-[#4A7766]/10 w-full transition-all duration-200 hover:bg-white/60"
                              autoComplete="email"
                              autoCapitalize="off"
                              autoCorrect="off"
                              spellCheck="false"
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <div className="flex justify-between items-center mb-1.5">
                          ...
                          <a href="/esqueci-senha" className="text-[10px] font-medium text-transparent bg-clip-text bg-gradient-to-r from-[#4A7766] to-[#3A5F52] hover:from-[#3A5F52] hover:to-[#2A4F42] transition-all duration-200">
                            Esqueceu a senha?
                          </a>
                        </div>
                        <FormControl>
                  ...
                  <div className="space-y-1.5 my-2">
                    <label className="flex items-center cursor-pointer group">
                      <div className="relative">
                        ...
                        />
                        <div className="w-3.5 h-3.5 bg-gray-100 rounded peer-checked:bg-gradient-to-r peer-checked:from-[#4A7766] peer-checked:to-[#3A5F52] transition-all duration-200"></div>
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-9 rounded-xl text-xs font-semibold text-white bg-gradient-to-r from-[#4A7766] to-[#3A5F52] hover:from-[#3A5F52] hover:to-[#2A4F42] shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group mt-3"
          ...
          <TabsContent value="register">
            <div className="relative p-6 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl shadow-blue-900/10 border border-white/60 overflow-hidden">
              {/* Gradient orbs para efeito de profundidade */}
              <div className="absolute -top-24 -left-24 w-48 h-48 bg-gradient-to-br from-[#D4AF37]/20 to-[#B4942F]/20 rounded-full blur-3xl animate-pulse" />
              <div className="absolute -bottom-24 -right-24 w-48 h-48 bg-gradient-to-tr from-[#4A7766]/20 to-[#3A5F52]/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
              ...
              <Form {...registerForm}>
                <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-3">
                        ...
                        >
                          <div 
                            className={`relative flex flex-col items-center p-2.5 border-2 ${
                              field.value === "patient" 
                                ? "border-[#4A7766] bg-gradient-to-br from-[#4A7766]/10 to-[#3A5F52]/10 text-[#4A7766]" 
                                : "border-gray-200/50 text-gray-600 hover:border-[#4A7766]/50 hover:bg-gradient-to-br hover:from-[#4A7766]/5 hover:to-[#3A5F52]/5"
                          ...
                          >
                            {field.value === "patient" && (
                              <div className="absolute inset-0 bg-gradient-to-r from-[#4A7766]/10 to-[#3A5F52]/10 animate-pulse" />
                            )}
                        ...
                        <FormControl>
                          <div className="relative">
                            ...
                            <Input 
                              ...
                              className="pl-10 pr-3 py-2.5 rounded-xl h-11 text-sm bg-gray-50/50 border border-gray-200/50 focus:border-[#4A7766] focus:ring-4 focus:ring-[#4A7766]/10 w-full transition-all duration-200 hover:bg-white/60"
                        ...
                        <div className="relative">
                          ...
                          <div className="flex items-center space-x-2">
                            <div className="w-24 pl-10">
                              ...
                              >
                                <SelectTrigger className="rounded-xl h-11 text-sm bg-gray-50/50 border border-gray-200/50 focus:border-[#4A7766] focus:ring-4 focus:ring-[#4A7766]/10 transition-all duration-200 hover:bg-white/60">
                                  ...
                                  <FormItem>
                                    <FormControl>
                                      <Input 
                                        placeholder="12345" 
                                        disabled={isRegistering}
                                        className="rounded-xl h-11 text-sm bg-gray-50/50 border border-gray-200/50 focus:border-[#4A7766] focus:ring-4 focus:ring-[#4A7766]/10 w-full transition-all duration-200 hover:bg-white/60"
                                        onFocus={(e) => activeTab === 'register' && scrollToCenter(e.target)}
                                        {...field}
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <Input 
                                ...
                                disabled={isRegistering}
                                className="rounded-lg h-10 text-sm backdrop-blur-sm bg-white/80 border-gray-200 focus:border-[#4A7766] focus:ring-[#4A7766] shadow-md"
                                onFocus={(e) => activeTab === 'register' && scrollToCenter(e.target)}
                                {...field} 
                              />
                            </FormControl>
                            ...
                            <FormLabel className="text-xs text-gray-600">
                              ...
                              <Dialog>
                                <DialogTrigger asChild>
                                  <button
                                    type="button"
                                    className="text-[#4A7766] hover:underline font-medium text-xs"
                                  >
                                    Termos de Uso
                                  </button>
                                </DialogTrigger>
                                <DialogContent className="max-w-4xl max-h-[80vh] bg-white">
                                  <DialogHeader>
                                    ...
                                    <DialogDescription>
                                      Documento completo. Para consultar posteriormente, acesse <a href="/ajuda?tab=docs" className="text-[#4A7766] hover:underline">Central de Documentos</a>
                                    </DialogDescription>
                                  </DialogHeader>
                                  ...
                                  <Dialog>
                                    ...
                                    <DialogContent className="max-w-4xl max-h-[80vh] bg-white">
                                      <DialogHeader>
                                        ...
                                        <DialogDescription>
                                          Parceria gratuita e sem exclusividade. Para consultar posteriormente, acesse <a href="/ajuda?tab=docs" className="text-[#4A7766] hover:underline">Central de Documentos</a>
                                        </DialogDescription>
                                      </DialogHeader>
                                      <ScrollArea className="h-[60vh] w-full">
                                  ...
                                  <Dialog>
                                    ...
                                    <DialogContent className="max-w-4xl max-h-[80vh] bg-white">
                                      <DialogHeader>
                                        ...
                                        <DialogDescription>
                                          Termos para médicos prestadores de telemedicina. Para consultar posteriormente, acesse <a href="/ajuda?tab=docs" className="text-[#4A7766] hover:underline">Central de Documentos</a>
                                        </DialogDescription>
                                      </DialogHeader>
                                      <ScrollArea className="h-[60vh] w-full">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-11 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[#4A7766] to-[#3A5F52] hover:from-[#3A5F52] hover:to-[#2A4F42] shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group mt-4"
                    style={{ transition: 'all 200ms cubic-bezier(0.4, 0, 0.2, 1)' }}
                    disabled={isRegistering}
                  >
                    <div className="absolute inset-0 -top-[200%] bg-gradient-to-b from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 group-hover:top-0" />
        ...
        <div className="px-4 py-4 text-center">
          <p className="text-xs text-gray-500">
            © 2024 CN Vidas - Telemedicina de qualidade ao seu alcance
          </p>
        </div>
      </div>
    </div>
