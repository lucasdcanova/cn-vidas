    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 py-4 sm:py-6 md:py-8 max-w-4xl">
        ...
        <Card className="shadow-xl overflow-hidden">
          <CardHeader className="bg-gradient-to-r from-blue-600 to-blue-700 text-white text-center py-6 sm:py-8 px-4 sm:px-6">
            <div className="space-y-2">
              <div className="bg-red-500 text-white text-xs sm:text-sm font-bold px-3 sm:px-4 py-1 rounded-full inline-block mb-2 sm:mb-4">
                🔥 PROMOÇÃO DE LANÇAMENTO
              </div>
              <h1 className="text-xl sm:text-2xl md:text-3xl font-bold leading-tight">
                Em parceria com o Hospital São José o CNVidas chega a Taquari!
              </h1>
          ...
          <CardContent className="p-4 sm:p-6 md:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
              <div className="text-center">
                <Users className="w-10 h-10 sm:w-12 sm:h-12 text-blue-600 mx-auto mb-2 sm:mb-3" />
                <h3 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2">Médicos 24h</h3>
                <p className="text-xs sm:text-sm text-gray-600">
                  Consultas online a qualquer hora do dia
                </p>
              </div>
              <div className="text-center">
                <Heart className="w-10 h-10 sm:w-12 sm:h-12 text-blue-600 mx-auto mb-2 sm:mb-3" />
                <h3 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2">Parceria Local</h3>
                <p className="text-xs sm:text-sm text-gray-600">
                  Em parceria com o Hospital São José
                </p>
              </div>
              <div className="text-center">
                <Star className="w-10 h-10 sm:w-12 sm:h-12 text-blue-600 mx-auto mb-2 sm:mb-3" />
                <h3 className="font-semibold text-sm sm:text-base mb-1 sm:mb-2">Condições Especiais</h3>
                <p className="text-xs sm:text-sm text-gray-600">
            ...
            <div className="bg-gray-50 rounded-lg p-4 sm:p-6">
              ...
              <p className="text-xs text-center text-gray-500 mt-4 flex flex-wrap items-center justify-center gap-1">
                <span>Ao cadastrar-se, você concorda em receber</span>
